package com.example.nguyen_jerry.project;
...
import com.example.nguyen_jerry.project.Fragments.MainFragment;
import com.example.nguyen_jerry.project.Fragments.ImportFragment;
...
public class MainActivity extends AppCompatActivity
        ...
        // We use a support map fragment because mainactivity extends from AppCompatActivity
        // which extends from FragmentActivity
...
//        fm.beginTransaction().replace(R.id.content_frame, new MainFragment()).commit();
    ...
    @Override
    // Do all map thigns here
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        mMap.setOnInfoWindowClickListener(this);
        float zoom = 16.0f;
        LatLng Default = new LatLng(44.9745476,-93.2344259);
